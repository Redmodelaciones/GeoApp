<?php
	...
	$asunto="SOLICITUD DE INSCRIPCION NUEVO SOCIO";
	$plantilla="confirmation.html";
	$mi_correo="5singma@gmail.com";//Email que envia
	$mi_nombre="Redmodelaciones";//Nombre de organizacion o empresa que envia
	$responder_a="redmodelaciones1@gmail.com";//correo al cual pueden responder
	$nombres_responder="firstname";//Nombre de la organizacion a responder
	$address=array('calle'=>$email_cliente,'number'=>$telefono_cliente,'city'=>$ciudad,'country'=>$codigo_pais);//Arreglo que contiene la direccion del cliente
