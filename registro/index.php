...
<head>
	...
	<title>REGISTRO SOCIOS REMODELDORES --</title>
...
<div class="image-container set-full-height" style="background-image: url('assets/img/bgmap.png')">
            ...
            <div class="wizard-container"> 
                ...
                <!--        You can switch "ct-wizard-orange"  with one of the next bright colors: "ct-wizard-blue", "ct-wizard-green", "ct-wizard-orange", "ct-wizard-red"             -->
                    	...
                    	<div class="wizard-header">
                        	<h3>
                        	   <b>REGISTRO NUEVOS SOCIOS</b>! <br>
                        	   <small>Formulario de Registro</small>
                        	</h3>
                    	</div>
                    	<ul>
                            <li><a href="#about" data-toggle="tab">Información del Socio</a></li>
                            <li><a href="#account" data-toggle="tab">Información del Servicio</a></li>
                            <li><a href="#address" data-toggle="tab">Ubicación del Socio</a></li>
                        </ul>
                        
                        <div class="tab-content">
                            <div class="tab-pane" id="about">
                              <div class="row">
                                  <h4 class="info-text">Información del Socio </h4>
								  ...
								  <div class="col-sm-6 col-sm-offset-3">
                                      <div class="form-group">
                                          ...
                                          <input name="phone" type="text" class="form-control" placeholder="(505)7085855" required>
                                      </div>
                                  </div>
                              </div>
                            </div>
                            <div class="tab-pane" id="account">
                                ...
                                <div class="row">
                                   <div class="col-sm-4">
									<img src='assets/img/registro.jpg' class='img-responsive'>
								 
								 </div>
								   <div class="col-sm-8">
                                      <div class="form-group">
                                        <label>Tipo de Servicio<small>(requerido)</small></label>
                                        <select class='form-control' required name='style'>
											<option value=''>-- Selecciona --</option>
											<option value='Instalacion Tablayeso'>Instalacion de Tablayeso</option>
											<option value='Instalacion de Cielo Falso'>Instalacion de Cielo Falso</option>
											<option value='Aplicacion de Pintura'>Aplicacion de Pintura</option>
											<option value='Instalacion Electrica'>Instalacion Electrica</option>
											<option value='Instalacion de Pisos y Azulejos'>Instalacion Pisos y Azulejos</option>
										</select>
                                      </div>
                                      
									  <div class="form-group">
                                        <label>Experiencia en el area elegida<small>(requerido)</small></label>
                                        <select class='form-control' required name='talla'>
											<option value=''>-- Selecciona --</option>
											<option value='1 año'>1 año</option>
											<option value='2 años'>2 años</option>
											<option value='3 años'>3 años</option>
											<option value='4 años'>4 años ó Más.</option>
										</select>
                                      </div>
									  
									  <div class="form-group">
                                        <label>Tipo de Remodelador<small>(requerido)</small></label>
                            ...
                            <div class="tab-pane" id="address">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h4 class="info-text"> Información del Nuevo Socio</h4>
                                    </div>
                                    <div class="col-sm-7 col-sm-offset-1">
                                         <div class="form-group">
                                            <label>Direccion Exacta</label>
                                            <input type="text" name="street" class="form-control" placeholder="5ta Avenida 3-33 Zona 1" required>
                                          </div>
                                    </div>
                                    <div class="col-sm-3">
                                         <div class="form-group">
                                            <label>Latitud:</label>
                                            <input type="text" name="number" class="form-control" placeholder="15.72778" required>
                                          </div>
                                    </div>
                                    <div class="col-sm-5 col-sm-offset-1">
                                         <div class="form-group">
                                            <label>Longitud:</label>
                                            <input type="text" name="city" class="form-control" placeholder="-88.59444" required>
                                          </div>
                                    </div>
                                    <div class="col-sm-5">
                                         <div class="form-group">
    ...
    <div class="footer">
        ...
        <div class="container">
             Desarrollado  por <a href="#">J@Red</a>.
        </div>
    </div>
