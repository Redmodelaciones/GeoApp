...
$cancel_return = "https://redmodelaciones.online/asistente/1/index.php";
...
$success_return = "https://redmodelaciones.online/asistente/1/success.php";
$pizza_type = $_POST['pizza_type'];
if ($pizza_type == 10) {
$pizza_name = 'Plan1';
$pizza_code="Plan001";
} else if ($pizza_type == 49) {
$pizza_name = 'Plan2';
$pizza_code="Plan002";
...
$pizza_topping_details = "Plan con ".$topping_name1.$topping_name2.$topping_name3.$topping_name4.$topping_name5;
